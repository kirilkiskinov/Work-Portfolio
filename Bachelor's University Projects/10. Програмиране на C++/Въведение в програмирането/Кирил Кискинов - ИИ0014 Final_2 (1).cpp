...
//   cout << "Nai malkoto razstoqnie e " << Closest_dist(P, stp, n, pnt1, pnt2) << endl;
   cout << "Nai malkoto razstoqnie e " <<  S_Distance(P, n, pnt1, pnt2) << endl;
   cout << "s koordinati tochka (" << pnt1.poi1 << "," << pnt1.poi2 << ") i tochka ("
